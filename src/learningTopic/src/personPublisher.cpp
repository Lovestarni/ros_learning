/*
 * Filename: /home/skywalker/Documents/code/ros/catkin_ws/src/learningTopic/src/personPublisher.cpp
...
int main(int argc, char **argv){
    ...
    ros::Publisher person_info_pub = n.advertise<learningTopic::Person>("/person_info", 10);
    ros::Rate loop_rate(1);

    int count = 0;
    while (ros::ok()){
        learningTopic::Person person_msg;
        person_msg.name = "Tom";
        person_msg.age = 18;
        person_msg.sex = learningTopic::Person::male;
